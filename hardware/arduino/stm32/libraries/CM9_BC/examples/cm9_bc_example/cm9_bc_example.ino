...
bc_pose_t cm9_bc_ex_id[] __FLASH__ = {1,1};

bc_pose_t backnforth_1[] __FLASH__ = {1, 512};
bc_pose_t backnforth_2[] __FLASH__ = {1, 768};
bc_pose_t backnforth_3[] __FLASH__ = {1, 256};

bc_seq_t backnforth[] __FLASH__ = {{cm9_bc_ex_id,4},{backnforth_1,1000},{backnforth_2,1000},{backnforth_1,1000},{backnforth_3,1000}};
